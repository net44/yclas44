    ...
    <div class="bg-white shadow sm:rounded-lg mt-8">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="mt-2 max-w-xl text-sm leading-5 text-gray-500">
                <p>
                    <?=__('Please use the correct CSV format')?>. <a class="text-blue-600 hover:underline" href="https://raw.githubusercontent.com/yclas/guides/master/samples/import_coupons_example.zip"><?=__('Download example')?></a>.
                </p>
            </div>
