        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>
                    ...
                    <br>
                    <?=__('Categories')?>: <a href="https://raw.githubusercontent.com/yclas/guides/master/samples/import_categories_example.zip"><?=__('download example')?>.</a><br>
                    <?=__('Locations')?>: <a href="https://raw.githubusercontent.com/yclas/guides/master/samples/import_locations_example.zip"><?=__('download example')?>.</a>
                </p>
                <hr>
